...
const persidtedState = loadState();

const store = createStore(cartReducer , persidtedState);

store.subscribe(()=>{
    saveState(store.getState());
});

ReactDOM.render(<Provider store={store}><AppRoute /></Provider>,document.getElementById('react'));